// Is this set of cards a full deck?
//
// Example:
// 	Have an array of objects that correspond to a playing card 
// 	(queen of diamonds = {'queen':'diamond'})
//  Pass your deck to the isDeck() function. 
//			-> isDeck(deck);
